...
\begin{tikzpicture}[
  ...
  \begin{scope}[shift={(0, 0)}]
    \draw[white] (-7.75 * \d, -4.25 * \d) rectangle (7.75 * \d, 0.75 * \d);
    ...
    \fill[white, opacity=0.75] (-7.75 * \d, -4.25 * \d) rectangle (7.75 * \d, 0.75 * \d);
    ...
    \node[mid] at (-6 * \d, -2.75 * \d) { $\alpha_{1}$ };
    \node[mid] at (-2 * \d, -2.75 * \d) { $\alpha_{2}$ };
    \node[mid] at (+2 * \d, -2.75 * \d) { $\alpha_{3}$ };
    \node[mid] at (+5 * \d, -3.75 * \d) { $\alpha_{4}$ };
    \node[mid] at (+7 * \d, -3.75 * \d) { $\alpha_{5}$ };
