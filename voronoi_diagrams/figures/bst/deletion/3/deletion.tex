...
\begin{tikzpicture}[
  ...
  \begin{scope}[shift={(0, 0)}]
    ...
    \node (N3) at (0 * \d, 0 * \d) [unobsell] { $n_{2}, n_{1}$ };
    
    \node (N2) at (-4 * \d, -1 * \d) [unobsell] { $n_{6}, n_{2}$ };
    \node (N7) at (+4 * \d, -1 * \d) [unobsell] { $n_{1}, n_{6}$ };

    \node (N4) at (-2 * \d, -2 * \d) [unobscirc] { $n_{2}$ };
    \node (N5) at (-6 * \d, -2 * \d) [unobscirc] { $n_{6}$ };
    
    \node (N8) at (2 * \d, -2 * \d) [unobscirc] { $n_{1}$ };
    \node (N9) at (6 * \d, -2 * \d) [unobscirc] { $n_{6}$ };

    \foreach \B/\E in {N3/N2, N2/N4, N2/N5, N3/N7, N7/N8, N7/N9} {
