...
\begin{tikzpicture}[
  ...
  \begin{scope}[shift={(0, 0)}]
    ...
    \node[midteal] at (-6.5 * \d, 0) { $S = 2$ };
    \node[dark] at (-6.5 * \d, -0.3 * \d) { $y = 3.283$ };
  
    \node (N1) at (0 * \d, 0 * \d) [unobsell] { $-0.435$ };
    
    \node (N2) at (-4 * \d, -1 * \d) [unobsell] { $n_{6}, n_{2}$ };
    \node (N3) at (+4 * \d, -1 * \d) [unobsell] { $\vphantom{-}0.781$ };

    \node (N4) at (-2 * \d, -2 * \d) [unobscirc] { $n_{2}$ };
    \node (N5) at (-6 * \d, -2 * \d) [unobscirc] { $n_{6}$ };
    
    \node (N6) at (2 * \d, -2 * \d) [unobscirc] { $n_{6}$ };
    \node (N7) at (6 * \d, -2 * \d) [unobsell] { $\vphantom{-}6.186$ };
    
    \node (N8) at (+5 * \d, -3 * \d) [unobscirc] { $n_{1}$ };
    \node (N8) at (+5 * \d, -3 * \d) [ncirc] { $n_{1}$ };
    ...
    \foreach \B/\E in {N1/N3, N3/N7, N7/N8} {
