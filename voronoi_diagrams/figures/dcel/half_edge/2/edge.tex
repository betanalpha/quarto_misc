...
\begin{tikzpicture}[scale=2]
  ...
  \arrow{-2.000}{0.666}{-0.122}{0.209}{midteal}
  \node[midteal] at (-1, 0.65) { he.prv };
    
  \arrow{-0.122}{0.209}{0.154}{0.859}{midteal}
  \node[midteal] at (-0.2, 0.6) { he };
  
  \arrow{0.154}{0.859}{0.017}{2.000}{midteal}
    \node[midteal] at (-0.25, 1.5) { he.nxt };
  
  \arrow{0.154}{0.859}{-0.122}{0.209}{midteal}
  \node[midteal] at (0.4, 0.5) { he.twin };

  \fill[midteal] (-0.122, 0.209) circle (0.035);
