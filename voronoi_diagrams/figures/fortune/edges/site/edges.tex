...
\begin{tikzpicture}
  ...
  \begin{scope}
    ...
    \fill[dark] (\xinta, \yinta) circle (0.06) node[below right] { $b_{n_{6} n_{2}}$ };
    \fill[dark] (\xintb, \yintb) circle (0.06) node[above right] { $b_{n_{2} n_{6}}$ };
  \end{scope}
  
  \node[midteal] at (-0.1, -0.9) { he1 };
  \node[midteal] at (-1.0, -0.5) { he2 };
