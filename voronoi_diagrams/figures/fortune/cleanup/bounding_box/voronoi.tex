...
\begin{tikzpicture}
  ...
  % Face 6 
  \draw[->, >=Stealth, midteal, line width=0.5] (-3.000, -0.241)
    \foreach \x/\y in {-0.335/-0.001, -0.124/0.160, -0.122/0.209, -3.000/0.909} {
      -- (\x, \y)
  }; 

  % Face 2 
  \draw[->, >=Stealth, midteal, line width=0.5] (-3.000, -1.681)
