...
\begin{tikzpicture}
  ...
  \fill[lightteal] (0.017, 2.000)
    \foreach \x/\y in {0.017/2.000, 0.154/0.859, 0.904/0.059, 2.000/-0.05, 2/2} {
      -- (\x, \y)
  };
  ...
  \draw[midteal, line width=0.5] (-2.000, -1.212)
