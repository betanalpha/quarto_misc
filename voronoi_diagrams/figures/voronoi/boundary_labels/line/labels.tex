...
\begin{tikzpicture}[scale=2]
  ...
  \draw[darkteal, line width=1] (-2.000, -1.212) -- (-0.475, -0.497);
  \node[darkteal] at (-1, -0.55) { $(2, 3)$ };

  \foreach \x/\y in {-0.546/-0.192} {
    \fill[dark] (\x, \y) circle (0.025) node[left] { $s_{2}$ };
  }
  
  \foreach \x/\y in {-0.286/-0.747} {
    \fill[dark] (\x, \y) circle (0.025) node[below left] { $s_{3}$ };
  }
  
  \foreach \x/\y in {-0.254/-0.275} {
    \fill[dark] (\x, \y) circle (0.025) node[right] { $s_{7}$ };
  }
