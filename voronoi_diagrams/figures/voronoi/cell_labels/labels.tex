...
\begin{tikzpicture}[scale=2]
  ...
  \colorlet{custom}{darkteal};

  % 7
  \fill[custom, line width=1] (-0.475, -0.497)
  ...
  % 2
  \fill[custom, line width=1] (-2.000, -1.212)
    \foreach \x/\y in {-0.475/-0.497, -0.335/-0.001, -2.000/-0.151} {
      -- (\x, \y)
  };
  
  % 3
  \fill[custom, line width=1] (-0.251, -2.000)
    \foreach \x/\y in {-2/-2, -0.176/-1.538, -0.192/-0.516, -0.475/-0.497, -2.000/-1.212, -2/-2} {
      -- (\x, \y)
  };
  
  
  \colorlet{custom}{white};
  ...
  \foreach \x/\y in {-0.546/-0.192} {
    \fill[mid] (\x, \y) circle (0.025) node[left] { $s_{2}$ };
  }
  
  \foreach \x/\y in {-0.286/-0.747} {
    \fill[mid] (\x, \y) circle (0.025) node[below left] { $s_{3}$ };
  }
  
  \foreach \x/\y in {-0.254/-0.275} {
    \fill[mid] (\x, \y) circle (0.025) node[right] { $s_{7}$ };
  }

  %\draw[light, line width=1] (0.45365134, 0.06939605) circle (1.03370201);
