...
\begin{tikzpicture}
  ...
  \draw[custom, line width=0.5] (-0.475, -0.497)
  ...
  \foreach \x/\y in {-0.498/0.472, -0.546/-0.192, -0.286/-0.747, 
    ...
    \fill[dark, opacity=0.25] (\x, \y) circle (0.025);
  }
  
  %\draw[light, line width=0.5] (-0.4746626, -0.4967589) circle (0.3129511);
  %\fill[darkteal] (-0.4746626, -0.4967589) circle (0.025);

  %\foreach \x/\y in {-0.546/-0.192, -0.286/-0.747, -0.254/-0.275} {
  %  \fill[dark] (\x, \y) circle (0.025);
  %}

  \draw[light, line width=0.5] (0.45365134, 0.06939605) circle (1.03370201);

  
  \foreach \x/\y in {-0.498/0.472, -0.546/-0.192, -0.577/0.149} {
    \fill[dark] (\x, \y) circle (0.025);
  } 
